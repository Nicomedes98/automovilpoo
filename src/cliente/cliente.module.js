...
const cliente_service_1 = require("/Users/nicom/IdeaProjects/JavaScript/NESTJS/reto-automovil/src/cliente/services/cliente.service");
let ClienteModule = class ClienteModule {
};
ClienteModule = __decorate([
    (0, common_1.Module)({
        controllers: [cliente_controller_1.ClienteController],
        providers: [cliente_service_1.ClienteServices],
    })
], ClienteModule);
